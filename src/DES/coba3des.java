...
public class coba3des {
    ...
    public static void encryptDecrypt(String key, int chiperMode, File in, File out)
        ...
        SecretKey secretKey = skf.generateSecret(desedeKeySpec);
    ...
    public static void main(String[] args) {
        ...
        File decrypted = new File("C:\\Users\\SONY\\Desktop\\enkrpsidesede.txt");

        try {
            encryptDecrypt("1234567811223344987956321", Cipher.ENCRYPT_MODE, encrypted, decrypted);
